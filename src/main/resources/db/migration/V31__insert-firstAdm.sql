...
INSERT INTO auth (id, name, username_key, password_key,active)
SELECT gen_random_uuid(), 'Administrador do Sistema', 'adminsystem@gmail.com', 'Basket123@@',true  -- senha já criptografada com BCrypt
